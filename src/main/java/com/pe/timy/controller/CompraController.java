...
public class CompraController {
	...
	public String agregarProducto(Model model, CompraProducto compraProducto) {
		...
		for (CompraProducto detalle : detalleCompra) {
			if (detalle.getProducto().getProductoId().equals(compraProducto.getProducto().getProductoId())) {
				Integer nuevaCantidad = detalle.getCantidad() + compraProducto.getCantidad();
